...
Source0  : https://files.pythonhosted.org/packages/11/c6/9e16df5a5526f7dd2ad17284928e36fc341305fe74c7ab06bb5960a5da94/setuptools-58.0.2.tar.gz
...
%prep
%setup -q -n setuptools-58.0.2
cd %{_builddir}/setuptools-58.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630966842
...
cp %{_builddir}/setuptools-58.0.2/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
