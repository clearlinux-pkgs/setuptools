...
Source0  : https://files.pythonhosted.org/packages/a8/e7/1440b0d19054a5616e9e5beeaa22f68485aa9de20d187f04e52880b7ae7a/setuptools-59.2.0.tar.gz
...
%prep
%setup -q -n setuptools-59.2.0
cd %{_builddir}/setuptools-59.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637371217
...
cp %{_builddir}/setuptools-59.2.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
