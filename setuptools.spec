...
Version  : 35.0.0
Release  : 63
URL      : http://pypi.debian.net/setuptools/setuptools-35.0.0.zip
Source0  : http://pypi.debian.net/setuptools/setuptools-35.0.0.zip
...
%prep
%setup -q -n setuptools-35.0.0

%build
export LANG=C
export SOURCE_DATE_EPOCH=1492372805
