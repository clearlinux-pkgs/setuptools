...
Source0  : https://files.pythonhosted.org/packages/95/fe/2687907be1d6291a84a9b51220595a4f89d9477032c57f21e7c633465540/setuptools-47.3.1.zip
...
%prep
%setup -q -n setuptools-47.3.1
cd %{_builddir}/setuptools-47.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592417291
...
cp %{_builddir}/setuptools-47.3.1/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/a5234543d56e03c950c0080826b53a0cb97671af
