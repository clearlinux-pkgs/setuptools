...
%prep
%setup -q -n setuptools-45.1.0
cd %{_builddir}/setuptools-45.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579630455
...
cp %{_builddir}/setuptools-45.1.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/a5234543d56e03c950c0080826b53a0cb97671af
