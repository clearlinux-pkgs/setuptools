...
Version  : 53.1.0
Release  : 199
URL      : https://files.pythonhosted.org/packages/8f/6b/0dcf95d95086ce459152e4c0ac306f2dbbcf984177a2b8b77b320ebfbf22/setuptools-53.1.0.tar.gz
...
%prep
%setup -q -n setuptools-53.1.0
cd %{_builddir}/setuptools-53.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614275414
...
cp %{_builddir}/setuptools-53.1.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
