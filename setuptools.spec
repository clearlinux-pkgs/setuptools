...
Source0  : https://files.pythonhosted.org/packages/1e/5c/3d7b3d91a86d71faf5038c5d259ed36b5d05b7804648e2c43251d574a6e6/setuptools-58.2.0.tar.gz
...
%prep
%setup -q -n setuptools-58.2.0
cd %{_builddir}/setuptools-58.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633361698
...
cp %{_builddir}/setuptools-58.2.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
