...
%prep
%setup -q -n setuptools-54.0.0
cd %{_builddir}/setuptools-54.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614625229
...
cp %{_builddir}/setuptools-54.0.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
