...
%prep
%setup -q -n setuptools-56.1.0
cd %{_builddir}/setuptools-56.1.0
...
cp %{_builddir}/setuptools-56.1.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
