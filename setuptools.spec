...
Source0  : https://files.pythonhosted.org/packages/59/b8/adeb445fa6c636f78c532f0dd6f847f0f90e709afa7d41396181d438be5a/setuptools-58.1.0.tar.gz
...
%prep
%setup -q -n setuptools-58.1.0
cd %{_builddir}/setuptools-58.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632323585
...
cp %{_builddir}/setuptools-58.1.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
