...
%prep
%setup -q -n setuptools-49.6.0
cd %{_builddir}/setuptools-49.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597418043
...
cp %{_builddir}/setuptools-49.6.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/a5234543d56e03c950c0080826b53a0cb97671af
