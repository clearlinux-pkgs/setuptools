...
Source0  : https://files.pythonhosted.org/packages/1d/32/94680de1e9153e4fd9d15f82a919c732a046a851b2ccd0c5b05f4ece346b/setuptools-57.2.0.tar.gz
...
%prep
%setup -q -n setuptools-57.2.0
cd %{_builddir}/setuptools-57.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626366297
...
cp %{_builddir}/setuptools-57.2.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
