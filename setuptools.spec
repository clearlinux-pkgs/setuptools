...
Source0  : https://files.pythonhosted.org/packages/02/b5/456e90af3712ca1b25c60ed74d0facb8b65cbaaa42cdceedf3b210580eef/setuptools-58.4.0.tar.gz
...
%prep
%setup -q -n setuptools-58.4.0
cd %{_builddir}/setuptools-58.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635785272
...
cp %{_builddir}/setuptools-58.4.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
