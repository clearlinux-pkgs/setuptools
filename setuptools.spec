...
Source0  : https://files.pythonhosted.org/packages/9a/74/de4d8c69466b6413b1616048b39f8b73d65f98c15f6202b68ccfc9550f1f/setuptools-58.0.4.tar.gz
...
%prep
%setup -q -n setuptools-58.0.4
cd %{_builddir}/setuptools-58.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631214225
...
cp %{_builddir}/setuptools-58.0.4/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
