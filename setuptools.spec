...
Source0  : https://files.pythonhosted.org/packages/e6/e2/f2bfdf364e016f7a464db709ea40d1101c4c5a463dd7019dae0a42dbd1c6/setuptools-59.5.0.tar.gz
...
%prep
%setup -q -n setuptools-59.5.0
cd %{_builddir}/setuptools-59.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638829929
...
cp %{_builddir}/setuptools-59.5.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
